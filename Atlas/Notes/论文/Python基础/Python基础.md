...
学习
![[image-1787034784978.webp|400x184]]
改值
引用指向改变
![[image-1787034924248.webp|400x193]]
如果删除
![[image-1787034970577.webp|400x202]]
Python中常见的不可变对象和可变对象
![[image-1787035025759.webp|400x46]]
举例列表
![[image-1787035439138.webp|400x181]]
关于类
![[image-1787035650346.webp|400x181]]

#### 9.22重新认识函数

学习
![[image-1787036787516.webp|400x195]]
可变参数 不可变参数
![[image-1787037403901.webp|400x212]]
重要
![[image-1787037716682.webp|400x336]]
代码
```python
# 1.函数也是对象  
# a1 = 100  # int类的实例对象  
...
​
方法
![[image-1787038968797.webp|400x227]]
#### 9.23多返回值-参数的打包与解包
...
浅拷贝
![[image-1787058751121.webp|400x212]]

![[image-1787058824026.webp|400x225]]

![[image-1787059236312.webp|400x208]]
嵌套数据仍然共享，修改嵌套数据会相互影响
![[image-1787059283934.webp|400x225]]
深拷贝
![[image-1787059697220.webp|400x208]]
换路
![[image-1787059780589.webp|400x220]]

#### 9.34 四种作用域
![[image-1787213001435.webp|400x243]]
![[image-1787213104855.webp|400x270]]
